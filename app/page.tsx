      ...
      <div style={{ position:'relative', background:'#111f12', borderRadius:20, overflow:'hidden', border:'1px solid rgba(255,255,255,0.1)', boxShadow:'0 48px 120px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,255,255,0.05), inset 0 1px 0 rgba(255,255,255,0.07)' }}>
        ...
        <div style={{ background:'#0d1a0f', padding:20 }}>
          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:22, padding:'8px 14px', background:'rgba(255,255,255,0.03)', borderRadius:8, border:'1px solid rgba(255,255,255,0.06)' }}>
            <span style={{ fontSize:13, fontWeight:700, color:'#c8f04b', fontFamily:'Outfit, sans-serif' }}>⚡ Sydney Plumbing</span>
          ...
          <div style={{ padding:'0 4px 8px' }}>
            <h3 style={{ fontFamily:'Fraunces, serif', fontSize:20, fontWeight:700, color:'white', margin:'0 0 8px', lineHeight:1.2 }}>Licensed Plumbers<br/>Across Sydney</h3>
            <p style={{ fontSize:11, color:'rgba(255,255,255,0.38)', margin:'0 0 16px', fontFamily:'Outfit, sans-serif' }}>Emergency callouts · Hot water · Gas fitting</p>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:8 }}>
              {[{ icon:'🔧', title:'Emergency' },{ icon:'🔥', title:'Gas Fitting' },{ icon:'🚿', title:'Renovations' }].map(c => (
...
// ─── Data ──────────────────────────────────────────────────────────
const STEPS = [
  { n:'01', icon:'📋', title:'Tell us about your business',   desc:"A fast intake form captures your services, trade, and suburb coverage — takes under 10 minutes." },
...
const FEATURES = [
  { icon:'🎨', title:'Premium Design',       desc:'Hand-crafted template adapted to your trade and brand colours.' },
  ...
  { icon:'✏️', title:'Free Revision Round',   desc:'One free change request before launch — no hidden extras.' },
...
const TESTIMONIALS = [
  { quote:"I was sceptical about AI-built sites but the result blew me away. Suburb pages are ranking already and I've had three new quote requests this week alone.", name:'Dave Kowalski', co:'D&K Plumbing',       city:'Sydney',    init:'DK', rating:5 },
  { quote:"Got my new landscaping site live in 36 hours. The content is spot-on and my clients say it looks way more professional than my old one. 10/10.",           name:'Mel Torres',   co:'TorresScapes',       city:'Melbourne', init:'MT', rating:5 },
  { quote:"SiteForge handled everything — copy, SEO, domain, the lot. I just filled in the form and woke up to a live website. Insane value for the price.",          name:'Jason Nguyen', co:'Nguyen Electrical',  city:'Brisbane',  init:'JN', rating:5 },
]

const PLANS = [
  {
    tier:'Starter', price:'599', delivery:'14-DAY DELIVERY', popular:false,
    desc:'Perfect for local tradies who need a clean, professional web presence fast.',
    features:['5-page website','5 suburb landing pages','SEO-ready copy','Mobile optimised design','SSL + Vercel hosting','Google Search Console setup'],
  },
  {
    tier:'Professional', price:'999', delivery:'7-DAY DELIVERY', popular:true,
    desc:'Best value for contractors who want a complete local marketing machine.',
    features:['10-page website','20 suburb landing pages','Schema markup + structured data','Blog + content hub setup','Booking widget integration','GA4 + Search Console'],
  },
  {
    tier:'Premium', price:'1,799', delivery:'48-HOUR DELIVERY', popular:false,
    desc:'Fastest launch. Priority support, booking setup, and maximum suburb coverage.',
    features:['15-page website','40 suburb landing pages','Priority build queue','Booking + CRM integration','WhatsApp + call tracking','Everything in Professional'],
  },
]

const FAQS = [
  { q:'How long does it really take to build my website?',       a:"Our Starter plan takes up to 14 days. Professional is 7 days, and Premium is 48 hours from the moment you complete your intake form. Most clients receive their staging link within 15 minutes of our team starting." },
  { q:'Can I request changes after the website is launched?',    a:"Every plan includes one free revision round before launch. After that we offer a low-cost monthly retainer for ongoing changes, new suburb pages, and content updates." },
  { q:'Do you handle hosting and domain setup?',                 a:"Yes. We deploy to Vercel's free tier (enterprise-grade and globally fast) and connect your domain. If you don't have a domain yet, we'll help you register one for around $15–25/year." },
  { q:'Is the AI-generated content actually good quality?',      a:"Every piece of copy is reviewed by our team before you see it. The AI writes the first draft using your intake answers, and we refine it to make sure it sounds natural, professional, and specific to your business." },
  { q:'What if I already have a domain?',                        a:"No problem. We connect your existing domain to the new Vercel deployment. If you're migrating from an existing site, we handle the transition to avoid any downtime." },
  { q:'Is there a lock-in contract?',                            a:"None at all. You own the code, the domain, and all the content. You can take your site to any host or developer at any time. We earn your loyalty through quality, not contracts." },
]
    ...
    <div style={{ background:'#080f0a', color:'white', fontFamily:'Outfit, sans-serif', overflowX:'hidden' }}>
      ...
      <div className="sf-hero-wrap">
        ...
        <div className="sf-hero-left">
          <div className="reveal" style={{ display:'inline-flex', alignItems:'center', gap:8, background:'rgba(200,240,75,0.08)', border:'1px solid rgba(200,240,75,0.24)', padding:'7px 18px', borderRadius:9999, marginBottom:32, boxShadow:'0 0 20px rgba(200,240,75,0.08)' }}>
            ...
            <span style={{ fontSize:10, fontWeight:700, letterSpacing:'0.12em', color:'#c8f04b' }}>AI-BUILT WEBSITES FOR AUSTRALIAN TRADIES</span>
          </div>
          ...
          <p className="reveal reveal-delay-2" style={{ fontSize:'clamp(16px,1.9vw,18px)', color:'rgba(255,255,255,0.52)', maxWidth:500, margin:'0 0 44px', lineHeight:1.88 }}>
            Premium local websites built for tradies, contractors and service businesses — content, SEO, suburb pages and full launch support included.
          </p>
          ...
          <div className="reveal reveal-delay-4" style={{ display:'flex', gap:24, flexWrap:'wrap' }}>
            {['No lock-in contracts','Free revision included','250+ sites delivered'].map(t => (
      ...
      <div ref={statsRef} style={{ background:'#0c1a0d', borderTop:'1px solid rgba(255,255,255,0.06)', borderBottom:'1px solid rgba(255,255,255,0.06)' }}>
        <div className="sf-inner sf-stats-grid">
          {[
            { val:250, suf:'+',   pre:'',  label:'Sites delivered',    sub:'for Australian tradies'  },
            { val:48,  suf:'hrs', pre:'',  label:'Premium turnaround', sub:'from brief to live'       },
            { val:599, suf:'',    pre:'$', label:'Starting price',     sub:'all-in, no hidden fees'  },
            { val:100, suf:'%',   pre:'',  label:'AU local focus',     sub:'tradies only, always'    },
          ].map((s, i) => (
      ...
      <section id="features" className="sf-sec" style={{ background:'linear-gradient(180deg,#0a1309 0%,#080f0a 100%)' }}>
        <div className="sf-inner">
          <div className="reveal" style={{ textAlign:'center', marginBottom:'clamp(40px,6vw,64px)' }}>
            ...
            <h2 style={h2}>Everything a tradie site <em style={{ color:'#c8f04b', fontStyle:'italic' }}>actually needs</em></h2>
      ...
      <section id="reviews" className="sf-sec" style={{ background:'#080f0a' }}>
        <div className="sf-inner">
          <div className="reveal" style={{ textAlign:'center', marginBottom:'clamp(40px,6vw,64px)' }}>
            <span style={chip}>REAL TRADIE RESULTS</span>
            <h2 style={h2}>What our clients <em style={{ color:'#c8f04b', fontStyle:'italic' }}>say</em></h2>
            <p style={{ fontSize:16, color:'rgba(255,255,255,0.42)', maxWidth:520, margin:'12px auto 0', lineHeight:1.75 }}>
              Australian tradies who launched with SiteForge and saw results in the first week.
            </p>
          </div>
      ...
      <section id="faq" className="sf-sec" style={{ background:'#080f0a' }}>
        <div className="sf-inner-sm">
          <div className="reveal" style={{ textAlign:'center', marginBottom:'clamp(36px,5vw,60px)' }}>
            ...
            <h2 style={h2}>Questions tradies <em style={{ color:'#c8f04b', fontStyle:'italic' }}>always ask</em></h2>
      ...
      <section className="sf-sec" style={{ textAlign:'center', position:'relative', overflow:'hidden', background:'linear-gradient(135deg,#0c1e0e 0%,#163520 50%,#0c1e0e 100%)' }}>
        ...
        <div className="reveal" style={{ position:'relative', maxWidth:640, margin:'0 auto' }}>
          ...
          <p style={{ fontSize:'clamp(15px,1.8vw,17px)', color:'rgba(255,255,255,0.48)', maxWidth:480, margin:'0 auto 44px', lineHeight:1.75 }}>
            Every day without a professional site is leads going to the tradie down the road. Launch yours in 48 hours — starting from $599.
          </p>
        ...
        <div className="sf-inner-frm">
          ...
          {submitted ? (
            ...
            <form onSubmit={submit} className="reveal glass-card" style={{ background:'rgba(255,255,255,0.03)', border:'1px solid rgba(255,255,255,0.09)', borderRadius:24, padding:'clamp(28px,4vw,44px) clamp(24px,4vw,40px)', boxShadow:'0 32px 80px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.07)' }}>
              ...
              <div className="sf-form-row">
                <FS label="BUSINESS TYPE *" value={form.niche} onChange={v => up('niche',v)} placeholder="Select your trade"
                  opts={['Plumbing','Electrical','Cleaning','Landscaping','Pest Control','Painting','HVAC','Handyman','Locksmith','Carpentry','Tiling','Fencing','Roofing','Concreting','Other']} />
              ...
              <FS label="PACKAGE INTEREST" value={form.plan} onChange={v => up('plan',v)} placeholder="Not sure yet — help me choose"
                opts={['Not sure yet — help me choose','Starter ($599)','Professional ($999)','Premium ($1,799)']} />
        ...
        <div className="sf-inner">
          <div className="sf-footer-grid">
            <div>
              ...
              <p style={{ fontSize:13, color:'rgba(255,255,255,0.28)', lineHeight:1.75, margin:'0 0 20px', maxWidth:240 }}>
                Premium websites for Australian tradies and local businesses — live in 48 hours.
              </p>
            ...
            {[
              ...
              { title:'Trades We Serve', links:[['#quote','Plumbers'],['#quote','Electricians'],['#quote','Cleaners'],['#quote','Landscapers'],['#quote','Painters'],['#quote','Pest Control']] },
          ...
          <div className="sf-footer-bar">
            <p style={{ fontSize:12, color:'rgba(255,255,255,0.2)', margin:0 }}>
              © {new Date().getFullYear()} SiteForge AI. ABN 00 000 000 000. All rights reserved.
            </p>
...
const fi:   React.CSSProperties = { width:'100%', padding:'14px 17px', borderRadius:12, border:'1px solid rgba(255,255,255,0.1)', background:'rgba(255,255,255,0.04)', color:'white', fontSize:14, fontFamily:'Outfit, sans-serif', boxSizing:'border-box', boxShadow:'inset 0 1px 0 rgba(255,255,255,0.04), inset 0 -1px 0 rgba(0,0,0,0.12)' }
